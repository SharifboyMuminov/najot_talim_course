...
import 'package:default_project/data/models/one_call/feels_like_models.dart';
import 'package:default_project/data/models/one_call/temp_model.dart';
...
class DailyModels {
  ...
  final num windDeg;
  final num windGust;
  final List<WeatherModul> inWeatherModel;
  final num clouds;
  final num pop;
  final num rain;
  final num snow;
