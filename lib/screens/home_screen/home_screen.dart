                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Image.network(
                            cityModul.weatherModul[0].icon.getWeatherIconUrl(),
                            width: 200.we,
                          ),
                          RichText(
                            text: TextSpan(
                          ...
                          return Column(
                            children: [
                              Image.network(oneCallDataModels!
                                  .hourlyModels[index].inWeather[0].icon
                                  .getWeatherIconUrl()),
                              Text(
                                oneCallDataModels!.hourlyModels[index].dt
                                    .toInt()
                                    .getParsedHour(),
                                style: TextStyle(
                                  color: AppColors.c_313341,
